...
9. **Home side.** Point your solstone install at your relay by setting `SPL_RELAY_ENDPOINT` in `home/.env.local` and bootstrapping with an account token signed by your key.
