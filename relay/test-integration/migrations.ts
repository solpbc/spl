...
export const migrations = [
	...
	{
		name: "0009_purge_operations_confirmed",
		queries: [
			...
			"INSERT INTO purge_operations_0009 (operation_id_hash, snapshot_digest, state, expires_at) SELECT operation_id_hash, snapshot_digest, state, expires_at FROM purge_operations",
			"DROP TABLE purge_operations",
			"ALTER TABLE purge_operations_0009 RENAME TO purge_operations",
		],
	},
	{
		name: "0010_owner_purge_v1",
		queries: [
			...
			"INSERT INTO purge_operations_0010 (operation_id_hash, request_digest, disposition, expires_at) SELECT operation_id_hash, snapshot_digest, state, expires_at FROM purge_operations WHERE 0",
			"DROP TABLE purge_operations",
