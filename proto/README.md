...
- [`owner-purge-v1.json`](owner-purge-v1.json) — canonical owner-purge wire contract and conformance transcripts. It is not a browser API.
- [`owner-purge-readiness-v1.json`](owner-purge-readiness-v1.json) — canonical owner-purge v1 readiness probe contract and canonical transcripts.
