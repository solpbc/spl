...
- [`blob-uplink.md`](blob-uplink.md) — browser blob-uplink wire contract. Defines the cert-less browser DATA payload shape, HPKE fixture, and browser pair-dial RK subprotocol carrier.
