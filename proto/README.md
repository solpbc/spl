...
- [`purge.md`](purge.md) — internal portal-to-relay owner-purge envelope, canonical target snapshot, replay binding, and completion-confirmation contract. It is not a browser API.
