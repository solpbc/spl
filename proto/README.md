...
If you're new to the protocol: [`session.md`](session.md) first (the lifecycle), then [`framing.md`](framing.md) (what flows inside), then [`pairing.md`](pairing.md) and [`pair-window.md`](pair-window.md) (how a device first becomes able to dial), then [`tokens.md`](tokens.md) (the JWT shapes that authorize the rendezvous).
